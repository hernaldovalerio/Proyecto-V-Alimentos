...
public class TipoPersona {
    private short id;
    private String dscrp_tipo_persona;
    ...
    public String getDscrp_tipo_persona() {
        return dscrp_tipo_persona;
    }

    public void setDscrp_tipo_persona(String dscrp_tipo_persona) {
    ...
    public TipoPersona(short id, String dscrp_tipo_persona, short log_Activo, String id_Usr_Registro, Date fech_Registro, String id_Usr_Ult_Registro, Date fech_Ult_Registro) {
        this.id = id;
        this.dscrp_tipo_persona = dscrp_tipo_persona;
        this.log_Activo = log_Activo;
        this.id_Usr_Registro = id_Usr_Registro;
