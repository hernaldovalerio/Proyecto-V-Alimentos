...
public class EmisorTarjeta {
    ...
    public EmisorTarjeta(short id, String dscrp_tarjeta, short log_Activo, String id_Usr_Registro, Date fech_Registro, String id_Usr_Ult_Registro, Date fech_Ult_Registro) {
        this.id = id;
        this.dscrp_tarjeta = dscrp_tarjeta;
        this.log_Activo = log_Activo;
        this.id_Usr_Registro = id_Usr_Registro;
