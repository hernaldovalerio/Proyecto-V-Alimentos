...
public class DetallePedido {
    ...
    public DetallePedido(int id_pedido, int id, int id_producto, int id_est_pedido, int cantidad, double precio, short log_Activo, String id_Usr_Registro, Date fech_Registro, String id_Usr_Ult_Registro, Date fech_Ult_Registro) {
        this.id_pedido = id_pedido;
        this.id = id;
        this.id_producto = id_producto;
        this.id_est_pedido = id_est_pedido;
