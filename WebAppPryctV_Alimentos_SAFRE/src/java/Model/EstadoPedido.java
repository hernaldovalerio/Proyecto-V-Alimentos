...
public class EstadoPedido {
    ...
    public String getDscrp_pedido() {
        return dscrp_pedido;
    }

    public void setDscrp_pedido(String dscrp_pedido) {
        this.dscrp_pedido = dscrp_pedido;
    }
    ...
    public EstadoPedido(short id, String dscrp_pedido, short log_Activo, String id_Usr_Registro, Date fech_Registro, String id_Usr_Ult_Registro, Date fech_Ult_Registro) {
        this.id = id;
        this.dscrp_pedido = dscrp_pedido;
        this.log_Activo = log_Activo;
        this.id_Usr_Registro = id_Usr_Registro;
