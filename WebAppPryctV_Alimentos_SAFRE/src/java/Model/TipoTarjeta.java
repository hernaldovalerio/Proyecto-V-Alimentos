...
public class TipoTarjeta {
    private short id;
    private String dscrp_tipo_tarjeta;
    ...
    public String getDscrp_tipo_tarjeta() {
        return dscrp_tipo_tarjeta;
    }

    public void setDscrp_tipo_tarjeta(String dscrp_tipo_tarjeta) {
        this.dscrp_tipo_tarjeta = dscrp_tipo_tarjeta;
    }
    ...
    public TipoTarjeta(short id, String dscrp_tipo_tarjeta, short log_Activo, String id_Usr_Registro, Date fech_Registro, String id_Usr_Ult_Registro, Date fech_Ult_Registro) {
        this.id = id;
        this.dscrp_tipo_tarjeta = dscrp_tipo_tarjeta;
        this.log_Activo = log_Activo;
        this.id_Usr_Registro = id_Usr_Registro;
