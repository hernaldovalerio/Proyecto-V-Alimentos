...
public class MedioDespacho {
    ...
    public String getDscrp_medio() {
        return dscrp_medio;
    }

    public void setDscrp_medio(String dscrp_medio) {
        this.dscrp_medio = dscrp_medio;
    }
    ...
    public MedioDespacho(int id, String dscrp_medio, short log_Activo, String id_Usr_Registro, Date fech_Registro, String id_Usr_Ult_Registro, Date fech_Ult_Registro) {
        this.id = id;
        this.dscrp_medio = dscrp_medio;
        this.log_Activo = log_Activo;
        this.id_Usr_Registro = id_Usr_Registro;
