...
public class TipoPedido {
    private short id;
    private String dscrp_tipo_pedido;
    ...
    public String getDscrp_tipo_pedido() {
        return dscrp_tipo_pedido;
    }

    public void setDscrp_tipo_pedido(String dscrp_tipo_pedido) {
        this.dscrp_tipo_pedido = dscrp_tipo_pedido;
    }
    ...
    public TipoPedido(short id, String dscrp_tipo_pedido, short log_Activo, String id_Usr_Registro, Date fech_Registro, String id_Usr_Ult_Registro, Date fech_Ult_Registro) {
        this.id = id;
        this.dscrp_tipo_pedido = dscrp_tipo_pedido;
        this.log_Activo = log_Activo;
        this.id_Usr_Registro = id_Usr_Registro;
