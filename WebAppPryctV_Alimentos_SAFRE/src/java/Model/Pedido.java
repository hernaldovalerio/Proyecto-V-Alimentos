...
public class Pedido {
    ...
    public Pedido(int id, int id_persona, int id_tipo_pedido, int id_est_pedido, Date fech_pedido, short log_Activo, String id_Usr_Registro, Date fech_Registro, String id_Usr_Ult_Registro, Date fech_Ult_Registro) {
        this.id = id;
        this.id_persona = id_persona;
        this.id_tipo_pedido = id_tipo_pedido;
        this.id_est_pedido = id_est_pedido;
